...
<div style="margin-top:10px;margin-bottom:10px;border: 1px solid #c8dff0;height:90px;position: relative;background:#fff;" class="div_full_row">
<script type="text/javascript"><?php echo getAdvJs(13); ?></script>
</div>
<?php } ?>
...
<div class="div_full_row" style="background:#fff;border:1px solid #cfe1ef;">
	...
	<?php
		...
		if($displayWidth > 0 && $displayHeight > 0){
			$displayHeight = (978 * $displayHeight) / $displayWidth;
			$displayWidth = 978;
	...
	<div style="width:978px;" id="woyouxi_game_wrap">
		<div class="flashloadingbar" id="flashloadingbar" style="width:978px;"><div id="flashprogressbar" style="overflow:hidden;"><span></span></div></div>
		<div style="position:relative;margin:0px auto 0px auto;width:<?php echo $displayWidth; ?>px;height:<?php echo $displayHeight; ?>px;" id="woyouxi_game_content">
			<div id="swfloading" style="z-index:1;display:block;position:absolute;width:<?php echo $displayWidth; ?>px;height:<?php echo $displayHeight; ?>px;top:0px;left:0px;font-size:25px;font-weight:bold;color:#000;background:#4AC5FE;">
				<p id="advtimer" style="margin:5px 0px;padding:0px;font-size:12px;color:#fff;text-align:center;"></p>
				<p style="margin:5px 0px;padding:0px;text-align:center;color:#f00;">您的游戏正在后台加载,请稍后...</p>
			</div>
	...
	<div style="height:90px;border-top:1px solid #cfe1ef;">
		...
		<div style="float:left;width:309px;height:70px;padding:0px 10px;border-left:1px solid #cfe1ef;">
...
<?php require_once 'game/protected/views/uiparts/advs/google_bar_below_flash.php'; ?>
</div>
...
<div class="div_full_row" style="background:#fff;border:1px solid #cfe1ef;margin-top:10px;">
	<div style="padding:10px;">
		<p class="game_introduce_title" style="margin:0px;padding:0px;">操作方法:</p>
...
<?php //显示相似视频 ?>
<?php require_once "game/protected/views/uiparts/relativeovideo_bar.php"; ?>
...
<?php require_once "game/protected/views/uiparts/relativegame_bar.php"; ?>
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"我发现了一个好玩的游戏，大家快来速速围观","bdMini":"1","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
